...
<head>
  ...
  <?php
    ...
    $emission = $db->query("SELECT * FROM emission WHERE id_emission = $id");
    $emission = $emission->fetchAll(PDO::FETCH_ASSOC);

    $titre = $emission[0]["lib_emission"];

    $description = $emission[0]["desc_emission"];
